        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('update_character', ['id' => $id]) }}" enctype="multipart/form-data" >
                      @csrf
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <select id="name" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $character->title }}" autofocus>
                                <option value=""></option>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <img src="/uploads/images/{{ $character->image }}" style="max-width:100%; height:auto;">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="flat" type="text" class="form-control{{ $errors->has('flat') ? ' is-invalid' : '' }}" name="flat" value="{{ $character->flat }}" >
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input type="text" value="" id="nicknames" name="nicknames" value="">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <textarea id="description" type="password" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required>{{ $character->description }}</textarea>
...
$(function() {
  $(document).ready(function(){
    var elt = $('#nicknames');
    var curVals = {!! $character->humanNicknames() !!};
